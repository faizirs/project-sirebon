...
class KapalkuController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('wajib-retribusi.Kapalku.create', compact('jeniskapal','pemilikKapal'));
    }
    ...
    public function store(Request $request)
{
    ...
    public function edit(string $id)
    {
        ...
        $jeniskapal = RefJenisKapal::all();
        $pemilikKapal = WajibRetribusi::all();
        return view('wajib-retribusi.Kapalku.edit', compact('kapal', 'jeniskapal', 'pemilikKapal'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('kapalku.index')->with('success', 'Data kapal berhasil diedit');
    }
