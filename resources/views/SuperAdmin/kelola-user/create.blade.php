                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('kelola-user.store') }}" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select" id="level" name="level" onchange="toggleInputs()" required>
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">ID User Group</label>
                                        <div class="col-sm-9">
                                            <input type="number" name="id_user_group" class="form-control">
                                        </div>
                                    </div>
